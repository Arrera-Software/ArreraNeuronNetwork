...
listVille = ["Landrethun-le-nord","Boulogne-sur-mer"]
print("Beinvenu sur le programme de teste du chatbot. ")
mode = int(input("Facon de s'exprimer du chatbot\n1.Vousvoiment\n2.Tutoiment\n(1,2) $ "))
if mode == 1 : 
    neuron = ArreraNetwork(nom,user,genre,createur,bute,True,listeFonction,"configNeuron.json",2,listVille) 
else :
    neuron = ArreraNetwork(nom,user,genre,createur,bute,False,listeFonction,"configNeuron.json",2,listVille)
