        ...
        if self.__gestNeuron.getChatbot() == True : 
            ...
            if  (("salut" in requette)   or ("bonjour" in requette)  or( "bonsoir" in requette)):
                ...
                if (("raconter une blague" in requette) or ("raconte moi une blague" in requette) or ("raconte une blague" in requette)) :
                    if (("vous etes pas drole" in self.__oldrequette) or( "tu es pas drole" in self.__oldrequette) 
                        or ("c'est pas drole" in self.__oldrequette) or ("pas drole" in self.__oldrequette)) :
                    ...
                    if (("vous etes pas drole" in requette)  or ("tu es pas drole" in requette) 
                        ...
                        if (("raconter une blague" in self.__oldrequette) or ("raconte moi une blague" in self.__oldrequette) 
                            or ("raconte une blague" in self.__oldrequette) or ("je vous en raconte une" in self.__oldsortie) 
                            or ("je t'en raconte une" in self.__oldsortie)):
                        ...
                        if (("Avant de dire sa , laisse t'en raconter une" in self.__oldsortie) 
                            or ("Avant de dire sa , laissez-vous en raconter une" in self.__oldsortie)) :
                            if ("non" in requette) :
                                nbRand = random.randint(0,1)
                            ...
                            if (("Je peux vous en racontez une autre" in self.__oldsortie) 
                                or ("Je peux t'en raconter une autre" in self.__oldsortie) 
                                or ("Si tu veux je peux t'en raconter une autre" in self.__oldsortie)) :
                                ...
                                if (("Désoler de ne pas etre drole pour vous " in self.__oldsortie) 
                                    or ("Désoler si je ne suis pas drole" in self.__oldsortie) 
                                    or ("Désoler de ne pas etre drole pour toi" in self.__oldsortie)) :
                                    ...
                                    if (("comment ça va " in requette) or ("ca va" in requette) 
                                        ...
                                        if (("tu peux me parler de toi" in requette) 
                                            ...
                                            if (("tu es qui" in self.__oldrequette) or ("présente toi" in self.__oldrequette) 
                                                or ("présentation" in self.__oldrequette) or ("qui es tu" in self.__oldrequette) 
                                                or ("qui es tu" in self.__oldrequette)):
                                                if self.__etatVous == True:
                                            ...
                                            if (("tu es qui" in requette) or ("présente toi" in requette) 
                                                ...
                                                if (("toujours la"  in requette)  or ("es tu la" in requette) 
                                                    or (self.__name in requette) or ("tu es la" in requette) 
                                                        ...
                                                        if ("oui" in requette) :
                                                            ...
                                                            if ("non" in requette) : 
                                                                ...
                                                                if ("bien" in requette) :
                                                                    ...
                                                                    if (("je profite du calme du matin pour travailler peu"  in requette) and ("Que faites-vous si tôt ?" in self.__oldsortie) 
                                                                        or  ("juste des choses à faire." in requette) and ("Que faites-vous si tôt ?" in self.__oldsortie))  :
                                                                        nbRand = random.randint(0,1)
