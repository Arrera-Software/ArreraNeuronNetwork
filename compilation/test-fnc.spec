...
exe = EXE(
    pyz,
    a.scripts,
    [], # On garde a.binaries pour COLLECT pour le mode console=True sur test-fnc.py si besoin, mais standard c'est vide pour l'exe macOS
    ...
    strip=False,
    upx=True,
    console=True, # Application Terminal (CLI)
