...
case $choix in
    1|main)
        ...
        pyinstaller --clean compilation/test_main.spec
    ...
    4|test-user-setting)
        ...
        pyinstaller --clean compilation/test-user-setting.spec
